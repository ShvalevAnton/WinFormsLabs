...
namespace Create_MO_Word
{
    public partial class Form1 : Form
    {
        ...
        // Метод создаёт приложение Word – инициализирует новый объект Application и делает его невидимым
        private void NewDocument()
        {
            winword = new WordObj.Application();
            winword.Visible = false;
            WordObj.Document document = winword.Documents.Add();
            // Реализация верхнего колонтитула
            ...
            // Созданый документ делаем видимым
